        ...
        <b-col class="col" cols=7 md=7>
          ...
          <section class="highlights">
            <ul>
              ...
              <li>
                Used in two accredited univeristy courses 
              </li>
              <li>
          ...
          <ul class="links">
            <li>
              <a href="https://www.amazon.com/Get-Programming-Node-js-Jonathan-Wexler/dp/1617294748" target="_blank">
                <font-awesome-icon size="2x" :icon="['fab', 'amazon']" />
                View on Amazon
              </a>
            </li>
            <li>
              <a href="https://github.com/JonathanWexler/get-programming-with-nodejs" target="_blank">
            ...
            <li>
              <a href="https://www.oreilly.com/library/view/get-programming-with/9781617294747/" target="_blank">
                <font-awesome-icon size="2x" icon="book-reader" />
                View at Safari Books
              </a>
            </li>
            <li>
              <a href="https://www.barnesandnoble.com/w/get-programming-with-nodejs-jonathan-wexler/1126999339" target="_blank">
